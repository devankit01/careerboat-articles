...
export default function AdminArticleForm({
  ...
  return (
    <form onSubmit={onSubmit} className="max-w-4xl mx-auto space-y-6 p-6">
      <div>
      ...
      <div className="space-y-2">
        <label className="block text-base font-semibold">Content</label>
        ...
        <div className="border rounded-md">
          {editor ? (
            <EditorContent
              editor={editor}
              className="tiptap prose max-w-none p-3 min-h-[140px]"
            />
          ) : (
